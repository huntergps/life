...
class _MapScreenState extends ConsumerState<MapScreen> {
  ...
  Widget _buildFabs(
    ...
    // Nearby species chip — shows when user has GPS and is near a visit site
  ...
  void _showNearbySpeciesSheet(BuildContext context, VisitSite site, bool isEs) {
    showModalBottomSheet(
      ...
      builder: (ctx) => _NearbySpeciesPanel(site: site, isEs: isEs),
    );
  }
...
// ─────────────────────────────────────────────────────────────────────────────
// Nearby Species Panel — DraggableScrollableSheet
// ─────────────────────────────────────────────────────────────────────────────

class _NearbySpeciesPanel extends ConsumerWidget {
  final VisitSite site;
  final bool isEs;

  const _NearbySpeciesPanel({required this.site, required this.isEs});
